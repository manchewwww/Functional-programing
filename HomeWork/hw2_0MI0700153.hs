...
main = do
    --1 task
    getNameLengthColor db ((== 'Y'), (> 106)) == [("Pretty Woman",119),("The Man Who Wasn't There",116),("Logan's run",120),("Empire Strikes Back",111),("Star Trek",132),("Star Trek: Nemesis",116)]
    getNameLengthColor db ((== 'Y'), (> 237)) == []
    getNameLengthColor db ((== 'Y'), (> 238)) == []
    getNameLengthColor db ((== 'N'), (< 133)) == [("Terms of Endearment",132)]
    getNameLengthColor db ((== 'N'), (< 300)) == [("Terms of Endearment",132)]

    --2 task
    (getStudios db) [2001] == [("USA Entertainm.","Stephen Spielberg"),("Buzzfeed Entertainm.","Christian Baesler")] 
    (getStudios db) [2002] == [("Buzzfeed Entertainm.","Christian Baesler")]
    (getStudios db) [1990] == [("Disney","Merv Griffin"),("Buzzfeed Entertainm.","Christian Baesler")]
    (getStudios db) [1990, 2001, 1976] == [("Disney","Merv Griffin"),("USA Entertainm.","Stephen Spielberg"),("Buzzfeed Entertainm.","Christian Baesler")]
    (getStudios db) [1979, 2002] == [("Buzzfeed Entertainm.","Christian Baesler")]
